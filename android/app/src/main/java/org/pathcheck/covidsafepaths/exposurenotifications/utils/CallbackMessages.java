...
public class CallbackMessages {
    ...
    public static final String DEBUG_DETECT_EXPOSURES_ERROR_EN_NOT_ENABLED = "Exposure notifications must be enabled to detect exposures.";
    public static final String DEBUG_DETECT_EXPOSURES_ERROR_UNKNOWN = "Unknown error detecting exposures.";
    public static final String DEBUG_DETECT_EXPOSURES_ERROR = "The following error occurred when attempting to detect exposures: ";
