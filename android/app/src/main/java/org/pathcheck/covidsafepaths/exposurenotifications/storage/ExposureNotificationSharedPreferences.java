...
public class ExposureNotificationSharedPreferences {
  ...
  private static final String NETWORK_MODE_KEY =
      "ExposureNotificationSharedPreferences.NETWORK_MODE_KEY";
  ...
  private static final String REVISION_TOKEN =
      "ExposureNotificationSharedPreferences.REVISION_TOKEN";
  ...
  public enum NetworkMode {
    ...
    TEST,
    // Uses local faked implementations of the diagnosis key uploads and downloads;
