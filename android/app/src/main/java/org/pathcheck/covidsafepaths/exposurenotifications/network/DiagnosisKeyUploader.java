 ...
 *
 *  <p>Modified from Google sample app to remove country codes / upload to multiple servers.
 */
    ...
    protected Response<JSONObject> parseNetworkResponse(NetworkResponse response) {
      try {
        ...
        return response.statusCode < 400
            ? Response
            .success(new JSONObject(responseString), HttpHeaderParser.parseCacheHeaders(response))
