...
public final class Util {
  ...
  public static WritableArray getEnStatusWritableArray(boolean enabled) {
    final String enablement =
        enabled ? CallbackMessages.EN_ENABLEMENT_ENABLED : CallbackMessages.EN_ENABLEMENT_DISABLED;

    // Android differs from iOS in that an app can always request to enable Exposure Notifications.
    // No need to have it authorized in the OS settings prior to enabling it in the app.
