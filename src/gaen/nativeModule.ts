...
interface CheckInStatus {
  id?: string // Auto-generated by the native layer
  posixDate: number
  feelingGood: number
  symptoms: string[]
}
...
export const getCheckInStatus = async (id: string): Promise<CheckInStatus> => {
  return checkInModule.getCheckInStatus(id)
}
